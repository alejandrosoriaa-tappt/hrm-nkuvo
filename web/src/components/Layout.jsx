...
import {
  ...
  BarChart3, Settings, Moon, Sun, LogOut, Sparkles, CreditCard, Linkedin, LineChart
} from 'lucide-react'
...
const NAV_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/app/linkedin',     icon: Linkedin,  label: 'LinkedIn Score' },
    ]
  },
  {
    label: 'Herramientas',
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/app/admin',         icon: LineChart, label: 'Analítica' },
